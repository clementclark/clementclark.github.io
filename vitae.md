...
title: Vitae
h1: Vitae
subtitle: Education, academic/industry experience, and skills
---
...
- **Instructor, Ascitech – Academy of Science & Technology (2020–2021)** 

## Industry Experience

- **Senior DevOps Engineer – Secure Payment Systems, Vodacom/Vodafone (DRC, 2020–Present)**  
  Designed and secured large-scale distributed FinTech platforms; anomaly detection & monitoring; risk mitigation; security-by-design for cloud/API-driven systems.  

- **Big Data & Cloud Engineer, Astek China (2018–2019)** 

## Technical Skills

- Programming: Python, Java, C/C++, MATLAB  
- AI & Security: ML, Anomaly Detection, Cryptography}  
- Systems: Linux, Cloud, Microservices  
- Databases: Oracle, PostgreSQL, MongoDB 
- Simulation tools: NS-3, Cisco Packet Tracer  

## Languages

French (Fluent), English (Fluent), Chinese (Intermediate) 
